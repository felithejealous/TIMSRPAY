...
from backend.models import AttendanceLog, User, StaffProfile, Role
...
def _resolve_staff_id(db: Session, payload_staff_id: Optional[int], current_user: User) -> int:
    ...
    - admin can act on staff/cashier only for admin-side control if needed
    """
...
def clock_in(
    ...
    # extra protection: admin mismo bawal mag-self attendance
